...
import { CreditCard, History, Paperclip, FileText, Image as ImageIcon, Wallet, ArrowUpRight, CheckCircle2, AlertCircle, Clock } from 'lucide-react'
                   ...
                   <TableCell className="py-5 px-6 text-right">
                      <div className="flex justify-end gap-2">
                        <Button 
                           variant="ghost" 
                           size="sm"
                           className="rounded-xl h-9 hover:bg-white/5 font-bold text-xs gap-2"
               ...
               <TableRow>
                  <TableCell colSpan={6} className="text-center py-20 text-muted-foreground opacity-50">
                     <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="font-bold text-sm tracking-tight italic">No hay registros financieros pendientes de procesar.</p>
                     </div>
                  </TableCell>
               </TableRow>
            )}
